...
import { mentors } from '@/routes/mentorships'
import { registration } from '@/routes/user-profile'
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-5xl text-center">
                        ...
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                            Connect with mentors who inspire, guide, and help you achieve your personal and professional goals.
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <Link href={registration()} className="text-sm/6 font-semibold text-gray-900 dark:text-white">
                                Become a Mentor or Mentee {' '}<span aria-hidden="true">→</span>
                            </Link>
                        </div>
                    </div>

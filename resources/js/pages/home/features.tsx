...
const actions = [
    {
        ...
        text: 'Get matched with mentors who align with your career path, interests, and personal goals.',
        href: '#',
        icon: UsersIcon,
    ...
    },
    {
        ...
        text: 'Receive feedback, resources, and inspiration to keep improving both personally and professionally.',
        href: '#',
        icon: ClockIcon,
    ...
    },
    {
        ...
        text: 'Set clear learning or career goals and track your progress with milestones and achievements.',
        href: '#',
        icon: CheckBadgeIcon,
    ...
    },
    {
        ...
        text: "Highlight your achievements, milestones, and growth in your profile — show how far you’ve come.",
        href: '#',
